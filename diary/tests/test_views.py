...
class TestDiaryCreateView(LoggedInTestCase):
    ...
    def test_create_diary_failuer(self):
...
class TestDiaryUpdateView(LoggedInTestCase):
    ...
    def test_update_diary_failuer(self):
        """日記編集処理が失敗することを検証する"""
        ...
        # 日記編集処理（Post）を実行
        response = self.client.post(reverse_lazy('diary:diary_update', kwargs={'pk': 999}),params)
...
class TestDiaryDeleteView(LoggedInTestCase):
    ...
    def test_delete_diary_failuer(self):
        """日記削除処理が失敗することを検証する"""
